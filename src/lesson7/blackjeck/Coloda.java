...
public class Coloda implements IColoda {
    ...
    public Coloda() {
        ...
        cards[44] = new Card("Король пика", 4);
        cards[45] = new Card("Король трефа", 4);
        cards[46] = new Card("Король бубна", 4);
        cards[47] = new Card("Король черви", 4);

        cards[48] = new Card("Туз пика", 11);
